...
class QLearn(object):
    ...
    def testNetwork(self, bot, newState):
        ...
        alive = (newState is not None)
        return self.decideMove(newState, player, alive)
    ...
    def learn(self, batch):
        ...
        for sample, sample_idx in enumerate(batch):
    ...
    def decideMove(self, newState, player):
        ...
        if numpy.random.random(1) < self.network.epsilon:
            ...
            q_Values = self.network.valueNetwork.predict(numpy.array([newState]))[0]
