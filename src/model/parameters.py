...
# Field Parameters
HASH_BUCKET_SIZE = 20
SIZE_INCREASE_PER_PLAYER = 65
START_RADIUS = 5
START_MASS = 10
MAX_COLLECTIBLE_DENSITY = 0.005  # per unit area
MAX_VIRUS_DENSITY = 0.000175
VIRUS_BASE_SIZE = 100
VIRUS_BASE_RADIUS = numpy.sqrt(VIRUS_BASE_SIZE / numpy.pi)
...
CELL_MASS_DECAY_RATE = 1 - (0.01 * SPEED_MODIFIER)
