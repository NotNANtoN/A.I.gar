...
ENABLE_SELF_GRID_SECOND_LAST_FRAME = True if NUM_GREEDY_BOTS + NUM_NN_BOTS > 1 else False
...
ENABLE_ENEMY_GRID_SECOND_LAST_FRAME = True if NUM_GREEDY_BOTS + NUM_NN_BOTS > 1 else False
