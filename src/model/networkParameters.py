...
ENABLE_SELF_GRID = True if NUM_GREEDY_BOTS + NUM_NN_BOTS > 1 else False
ENABLE_SELF_GRID_LAST_FRAME = False
ENABLE_SELF_GRID_SECOND_LAST_FRAME = False
...
ENABLE_ENEMY_GRID_LAST_FRAME = False
ENABLE_ENEMY_GRID_SECOND_LAST_FRAME = False
ENABLE_SIZE_GRID = False
USE_FOVSIZE = True
USE_TOTALMASS = True
USE_LAST_ACTION = True if NUM_GREEDY_BOTS + NUM_NN_BOTS > 1 else False
USE_SECOND_LAST_ACTION = True if NUM_GREEDY_BOTS + NUM_NN_BOTS > 1 else False
...
NUM_OF_GRIDS = ENABLE_PELLET_GRID + ENABLE_SELF_GRID + ENABLE_WALL_GRID + ENABLE_VIRUS_GRID + ENABLE_ENEMY_GRID \
               + ENABLE_SIZE_GRID + ENABLE_SELF_GRID_LAST_FRAME + ENABLE_SELF_GRID_SECOND_LAST_FRAME \
               + ENABLE_ENEMY_GRID_LAST_FRAME + ENABLE_ENEMY_GRID_SECOND_LAST_FRAME
