...
ENABLE_SELF_GRID_LAST_FRAME = True if NUM_GREEDY_BOTS + NUM_NN_BOTS > 1 else False
ENABLE_SELF_GRID_SECOND_LAST_FRAME = False #True if NUM_GREEDY_BOTS + NUM_NN_BOTS > 1 else False
...
ENABLE_ENEMY_GRID_LAST_FRAME = True if NUM_GREEDY_BOTS + NUM_NN_BOTS > 1 else False
ENABLE_ENEMY_GRID_SECOND_LAST_FRAME = False #True if NUM_GREEDY_BOTS + NUM_NN_BOTS > 1 else False
...
STATE_REPR_LEN = GRID_SQUARES_PER_FOV * GRID_SQUARES_PER_FOV * NUM_OF_GRIDS \
                 + USE_FOVSIZE + USE_TOTALMASS + USE_LAST_ACTION * 4 + USE_SECOND_LAST_ACTION * 4

INITIALIZER = "glorot_uniform" #"Default" or "glorot_uniform" or "glorot_normal"
NEURON_TYPE = "MLP"
HIDDEN_ALL = 0
HIDDEN_LAYER_1 = HIDDEN_ALL if HIDDEN_ALL else 512
